  ...
  export default {
    ...
    methods: {
      ...
      formatDataForChart(data, year) {
        ...
        }).sort((a, b) => b.data[0] - a.data[0]).slice(0, 10)
      ...
      updateChartData(data, year) {
        ...
        this.top10TableData = this.tableData.filter(row => seriesData.map(d => d.name).includes(row.Comune))
      },
      adjustChartSize() {
